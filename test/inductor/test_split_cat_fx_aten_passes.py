...
class TestSplitCatPartial(torch.nn.Module):
    ...
    def forward(self, x1: torch.Tensor, x2: torch.Tensor, y: torch.Tensor, z: torch.Tensor):
        ...
        split_with_sizes_2 = torch.ops.aten.split_with_sizes.default(x2, [96, 96, 96, 96], 1)
